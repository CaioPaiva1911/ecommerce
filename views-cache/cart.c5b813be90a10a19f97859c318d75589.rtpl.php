                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                ...
                                                <input type="number" size="4" class="input-text qty text" title="Qty" min="0" value="<?php echo htmlspecialchars( $value1["nrqtd"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"  step="1">
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                <th>Subtotal</th>
                                                <td><span class="amount">R$<?php if( $cart["vlsubtotal"] > 0 ){ ?><?php echo formatPrice($cart["vlsubtotal"]); ?><?php } ?></span></td>
                                            </tr>

                                            <tr class="shipping">
                                                <th>Frete</th>
                                                <td>R$<?php if( $cart["vlfreight"] > 0 ){ ?><?php echo formatPrice($cart["vlfreight"]); ?><?php } ?><?php if( $cart["nrdays"] > 0 ){ ?><small>
